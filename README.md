...
```shell
git clone https://github.com/pratbapp/log-analyser.git
```

2. Open the project in an IDE of your choice.
3. Run the main application - `com.github.pratbapp.loganalyser.LogAnalyser`.
    1. Create/Update the Run Configuration for the class to provide the program argument.<br />
       ![Edit Run Config window on Intellij](sample argument - logfile.txt)

       <br />
       A sample log file is available in `resources/samples/logfile.txt`
    2. You can generate a sample log file using the
       utility `com.github.pratbapp.loganalyser.utilities.LogFileGenerator`. You can specify the number of events to
